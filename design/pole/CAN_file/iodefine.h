...
/*                                                                            */
/* Device     : RL78/R5F10BGE                                                 */
/* File Name  : iodefine.h                                                    */
/* Abstract   : Definition of Special Function Register (SFR)                 */
/* History    : V1.11  [Device File version]                                  */
/* Options    : -df=D:\Program Files\Renesas Electronics\CS+\CC\Device\RL78\D */
/*              evicefile\DR5F10BGE.DVF -o=E:\pro\rs\RL78CAN\can\can\iodefine */
/*              .h -f                                                         */
/* Date       : 2017/8/29                                                     */
...
/*                                                                            */
/******************************************************************************/
#ifndef __R5F10BGEIODEFINE_HEADER__
#define __R5F10BGEIODEFINE_HEADER__
...
#define BIT(n)				(1<<(n))
#define	BIT_SET(xxx,nnn)		((xxx)|=BIT(nnn))
#define BIT_CLR(xxx,nnn)		((xxx)&=~BIT(nnn))
#define BIT_XOR(xxx,nnn)		((xxx)=(xxx)^BIT(nnn))
#endif
